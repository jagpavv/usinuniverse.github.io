...
@IBAction func alert(_ sender: UIButton) {
        ...
        //alert 액션 정의하기
        let alertAction: UIAlertAction = UIAlertAction(title: "액션 타이틀 영역", style: .default, handler: nil)
        let alertAction2: UIAlertAction = UIAlertAction(title: "액션 타이틀 영역2", style: .cancel, handler: nil)
